  ...
  return (
    <div className={`${containerStyle}`}>
      ...
      <div className='w-full'>
        <input name={name} onChange={(e)=>setName(e.currentTarget.value)} className={`bg-[#aaaaaa]/50 text-xl px-2 py-1 rounded-lg border border-[#ffffff]/20 w-full ${inputStyle}`} type={isPassword ? (isPasswordVisible ? 'text' : 'password') : 'text'} />
